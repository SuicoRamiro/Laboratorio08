                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!--Bontones Editar|AgregarPromocion|Eliminar-->
                                <td><a class="btn btn-danger" href="editar.php?codigo=<?php echo $dato->id; ?>">Editar</a></td>
                                <td><a onclick="return confirm('¿Estás seguro de eliminar?');" class="btn btn-danger text-white" href="eliminar.php?codigo=<?php echo $dato->id; ?>">Eliminar</a></td>
                                <!--Redireccionar a agragarPromocion.php-->
